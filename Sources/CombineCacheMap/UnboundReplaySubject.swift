...
// This is a version of `CombineExt.ReplaySubject` modifier to have an unlimited buffer size.
// Credit: CombineCommunity / CombineExt
// https://github.com/CombineCommunity/CombineExt/blob/main/Sources/Subjects/ReplaySubject.swift
...
/// A `ReplaySubject` is a subject that can buffer one or more values. It stores value events and then replays it to
...
public final class UnboundReplaySubject<Output, Failure: Error>: Subject {
...
@available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
extension UnboundReplaySubject {
